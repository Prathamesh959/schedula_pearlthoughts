  ...
  return (
    <div className="min-h-screen flex flex-col px-6 pt-12 pb-8 bg-white">
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        <h2 className="text-lg font-bold text-gray-800">Your Logo</h2>
      </div>

      {/* Login Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Login</h1>
        <p className="text-sm text-gray-500 mt-1">Mobile / Email</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button type="button" className="text-xs text-[#00BCD4] font-medium hover:underline">
            Forgot Password
          </button>
        </div>
        ...
        <button
          type="button"
          className="w-full py-3.5 bg-white border border-gray-200 rounded-xl flex items-center justify-center gap-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all active:scale-[0.98]"
        >
